    ...
    <div class="auth-cadastro-cabecalho">
      <div>
        ...
        <?php if (!empty($_SESSION['flash_registro_erro'])): ?>
          <div class="alert alert-error">
            <?= h($_SESSION['flash_registro_erro']) ?>
          </div>
        ...
        <?php if (!empty($_SESSION['flash_registro_sucesso'])): ?>
          <div class="alert alert-success">
            <?= h($_SESSION['flash_registro_sucesso']) ?>
          </div>
...
<script>
  ...
  // Ex.: ?open=login  ou ?open=cadastro.
  // Mantém ?open=registro apenas por compatibilidade com links antigos.
  // =========================
